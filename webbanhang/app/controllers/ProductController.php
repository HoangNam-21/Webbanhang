...
if (!isset($_SESSION['cart'])) {
    ...
    public function list() {
        $products = $this->productModel->getProducts();
        $categories = $this->productModel->getCategories(); // Thêm hàm này trong model
        require_once 'app/views/product/list.php';
    }
    
    public function search() {
        $query = isset($_GET['query']) && !empty($_GET['query']) ? htmlspecialchars($_GET['query']) : '';
        $category_id = isset($_GET['category_id']) && !empty($_GET['category_id']) ? $_GET['category_id'] : '';
        
        $products = $this->productModel->searchProducts($query, $category_id);
        $categories = $this->productModel->getCategories(); // Để hiển thị dropdown
        require_once 'app/views/product/list.php';
    }
